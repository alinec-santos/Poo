 ...
 * @author aline
 */
public class TelaGanhouController implements Initializable {
    @FXML
    ...
    @FXML
    private void handlebtnAvancarAction(ActionEvent event) {
        try {
            ...
            // Fechar a tela atual
            Stage stageAtual = (Stage) btnAvancar.getScene().getWindow();
            stageAtual.close();
        } catch (IOException e) {
